...
<div style="padding: 0.5rem 1rem; background-color: #e8e8e8; border-radius: 13px;">
<h5 style="color: gray">def: 凸集合</h5>
...
$
\forall x, y \in C,\ \lambda \in [0, 1]$に対し, $\lambda x + ( 1 - \lambda ) y \in C
$
</div>
</div>
...
<div style="padding: 0.5rem 1rem; background-color: #e8e8e8; border-radius: 13px;">
<h5 style="color: gray">def: 凸関数</h5>
...
<div style="padding: 0.5rem 1rem; background-color: #e8e8e8; border-radius: 13px;">
<h5 style="color: gray">def: 特異値分解とシュティーフェル多様体</h5>
