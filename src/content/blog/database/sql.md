...
なお, ~~part11~~part9以降は別の本, [達人に学ぶDB設計 徹底指南書](https://www.amazon.co.jp/dp/B00EE1XPAI)と一緒にまとめる.
...
この定義では例えば, DBでの$i$行目のデータは$t_i(\text{社員番号}) = 101, t_i(\text{名前}) = "田中", t_i(\text{部署番号})=02$のように表現できる.
